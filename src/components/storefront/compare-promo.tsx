        ...
        <div className="overflow-hidden rounded-[var(--radius-xl)] bg-[var(--color-ink)] px-[var(--space-page)] py-14 text-white shadow-[var(--shadow-lg)] sm:py-20 lg:px-16 lg:py-24">
          <div className="grid items-center gap-14 lg:grid-cols-[0.82fr_1.18fr] xl:gap-20">
            <div>
              ...
              <Link className="mt-8 inline-flex min-h-12 items-center rounded-[var(--radius-round)] bg-white px-6 font-semibold text-[var(--color-ink)]" href="/compare">Start Comparing</Link>
              <p className="mt-3 text-sm text-[#aebbc7]">Select up to three products and compare confirmed details side by side.</p>
            </div>
