...
export default function ShopPage() { return <CatalogPage eyebrow="GADGETMOTO CATALOG" title="Find your next phone or tablet." description="Browse our current prototype selection and compare prices, categories, and available payment options." products={getAllProducts()} showAllTools />; }
