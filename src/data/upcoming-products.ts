...
export const upcomingProducts: readonly UpcomingProduct[] = [
  ...
  upcoming("honor-win-rt", "HONOR WIN RT", "HONOR", "Phone", 1122, 1402),
  upcoming("honor-win", "HONOR WIN", "HONOR", "Phone", 1122, 1402),
  upcoming("honor-x9d", "HONOR X9D", "HONOR", "Phone", 1122, 1402),
  upcoming("infinix-gt30-5g", "Infinix GT30 5G", "Infinix", "Phone", 1122, 1402),
  upcoming("infinix-gt30-pro", "Infinix GT30 Pro", "Infinix", "Phone", 1122, 1402),
  upcoming("infinix-hot-70", "Infinix Hot 70", "Infinix", "Phone", 1122, 1402),
  upcoming("infinix-note-edge-5g", "Infinix Note Edge 5G", "Infinix", "Phone", 1122, 1402),
  upcoming("infinix-note-60-ultra", "Infinix Note 60 Ultra", "Infinix", "Phone", 1122, 1402),
  upcoming("infinix-smart-20", "Infinix Smart 20", "Infinix", "Phone", 1122, 1402),
  ...
  upcoming("apple-iphone-14", "Apple iPhone 14", "Apple", "Phone", 1122, 1402),
  upcoming("apple-iphone-15", "Apple iPhone 15", "Apple", "Phone", 1122, 1402),
  upcoming("apple-iphone-16", "Apple iPhone 16", "Apple", "Phone", 1122, 1402),
  upcoming("iqoo-15-ultra", "iQOO 15 Ultra", "iQOO", "Phone", 1122, 1402),
  upcoming("iqoo-15", "iQOO 15", "iQOO", "Phone", 1122, 1402),
  upcoming("iqoo-z10-turbo-plus", "iQOO Z10 Turbo Plus", "iQOO", "Phone", 1122, 1402),
  upcoming("iqoo-z10-turbo-pro", "iQOO Z10 Turbo Pro", "iQOO", "Phone", 1122, 1402),
  upcoming("iqoo-z11-turbo", "iQOO Z11 Turbo", "iQOO", "Phone", 1024, 1536),
  upcoming("iqoo-z11", "iQOO Z11", "iQOO", "Phone", 1024, 1536),
  upcoming("itel-power70", "itel Power70", "itel", "Phone", 1024, 1536),
  upcoming("itel-s26-ultra", "itel S26 Ultra", "itel", "Phone", 1024, 1536),
  ...
  upcoming("oppo-a6t", "OPPO A6T", "OPPO", "Phone", 1122, 1402),
  upcoming("poco-c71", "POCO C71", "POCO", "Phone", 1122, 1402),
  upcoming("poco-c81-pro", "POCO C81 Pro", "POCO", "Phone", 1122, 1402),
  upcoming("poco-f6", "POCO F6", "POCO", "Phone", 1122, 1402),
  upcoming("poco-f7", "POCO F7", "POCO", "Phone", 1122, 1402),
  upcoming("poco-m8-5g", "POCO M8 5G", "POCO", "Phone", 1122, 1402),
  upcoming("poco-m8-pro-5g", "POCO M8 Pro 5G", "POCO", "Phone", 1024, 1536),
  upcoming("poco-m8s", "POCO M8s", "POCO", "Phone", 1122, 1402),
  upcoming("poco-pad-m1", "POCO Pad M1", "POCO", "Tablet", 1023, 1537),
  upcoming("poco-x7-pro", "POCO X7 Pro", "POCO", "Phone", 1122, 1402),
  upcoming("poco-x8-pro-max", "POCO X8 Pro Max", "POCO", "Phone", 1122, 1402),
  upcoming("poco-x8-pro", "POCO X8 Pro", "POCO", "Phone", 1122, 1402),
  upcoming("redmi-15-5g", "Redmi 15 5G", "Redmi", "Phone", 1122, 1402),
  upcoming("redmi-15c-5g", "Redmi 15C 5G", "Redmi", "Phone", 1122, 1402),
  upcoming("redmi-a5", "Redmi A5", "Redmi", "Phone", 1122, 1402),
  upcoming("redmi-a7-pro", "Redmi A7 Pro", "Redmi", "Phone", 1122, 1402),
  upcoming("redmi-k90-max", "Redmi K90 Max", "Redmi", "Phone", 1122, 1402),
  upcoming("redmi-k90-pro-max", "Redmi K90 Pro Max", "Redmi", "Phone", 1122, 1402),
  upcoming("redmi-k90", "Redmi K90", "Redmi", "Phone", 1122, 1402),
  upcoming("redmi-note-15", "Redmi Note 15", "Redmi", "Phone", 1122, 1402),
  upcoming("redmi-note-15-pro-5g", "Redmi Note 15 Pro 5G", "Redmi", "Phone", 1122, 1402),
  ...
  upcoming("redmi-turbo-4", "Redmi Turbo 4", "Redmi", "Phone", 1122, 1402),
  upcoming("redmi-turbo-5-max", "Redmi Turbo 5 Max", "Redmi", "Phone", 1024, 1536),
  upcoming("samsung-galaxy-a07-lte", "Samsung Galaxy A07 LTE", "Samsung", "Phone", 1024, 1536),
  upcoming("tecno-camon-50-ultra", "TECNO Camon 50 Ultra", "TECNO", "Phone", 1024, 1536),
  upcoming("tecno-pova-curve-2", "TECNO Pova Curve 2", "TECNO", "Phone", 1024, 1536),
  upcoming("tecno-pova-curve", "TECNO Pova Curve", "TECNO", "Phone", 1024, 1536),
  upcoming("tecno-pova-7", "TECNO Pova 7", "TECNO", "Phone", 1024, 1536),
  upcoming("tecno-spark-50", "TECNO Spark 50", "TECNO", "Phone", 1024, 1536),
  upcoming("tecno-spark-go-3", "TECNO Spark Go 3", "TECNO", "Phone", 1024, 1536),
  ...
  upcoming("xiaomi-17t-pro", "Xiaomi 17T Pro", "Xiaomi", "Phone", 1024, 1536),
];
